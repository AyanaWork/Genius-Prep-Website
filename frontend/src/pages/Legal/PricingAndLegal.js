    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-[#1a2332] py-12">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl font-bold text-white">Pricing & Legal</h1>
          <p className="text-gray-400 mt-2">Transparent pricing and policies for Genius Prep Tuition</p>
        </div>
      </div>
        ...
        {activeTab === 'pricing' && (
          <div className="space-y-12">
            <div className="text-center">
              <h2 className="text-3xl font-bold text-[#2c3e50] mb-4">Our Pricing</h2>
            ...
            <div>
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-sm max-w-3xl mx-auto">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                  <h4 className="font-semibold text-[#2c3e50] mb-2">Booking Requirements</h4>
        ...
        {activeTab === 'terms' && (
          <div className="bg-white rounded-xl shadow-sm p-8 space-y-8">
            ...
            {[
              ...
              <section key={i}>
                <h3 className="text-lg font-bold text-[#2c3e50] mb-2">{section.title}</h3>
            ...
            <button
              onClick={() => navigate('/terms')}
              className="w-full py-3 border-2 border-[#4A90E2] text-[#4A90E2] rounded-lg font-semibold hover:bg-[#4A90E2] hover:text-white transition"
            >
        ...
        {activeTab === 'refund' && (
          <div className="bg-white rounded-xl shadow-sm p-8 space-y-8">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
              <h3 className="font-bold text-[#2c3e50] mb-3">GPA Subscriptions</h3>
              <div className="space-y-2 text-sm text-gray-700">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <h3 className="font-bold text-[#2c3e50] mb-2">How to Request a Refund</h3>
              <p className="text-gray-700 text-sm">
                Email <a href="mailto:hello@geniuspreptuition.co.za" className="text-[#4A90E2]">hello@geniuspreptuition.co.za</a> with your
