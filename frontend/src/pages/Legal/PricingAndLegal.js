    ...
    <div className="min-h-screen bg-[#0f172a] text-white">
      ...
      <div className="bg-[#0a101f] border-b border-white/10 py-12">
        <div className="container mx-auto px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-black text-center leading-[1.15] pb-2 bg-gradient-to-r from-[#00CC99] to-emerald-400 bg-clip-text text-transparent">Pricing & Legal</h1>
